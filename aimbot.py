...
class init():
    console_log1 = "Loading..."
    console_log2 = "Create a window..."
    console_log3 = "Searching..."
    print("Console Log " + console_log1 + console_log2 + console_log3)
...
try:
    ...
    if show_frame:
        cv2.namedWindow('Cheat', cv2.WINDOW_NORMAL)
